    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            <div class="cl pd-5 bg-1 bk-gray"><span class="l"> <a href="javascript:;" onclick="datadel()"
                            ...
                            onclick="admin_role_add('添加角色','admin-role-add.html','800')"><i class="Hui-iconfont">&#xe600;</i> 添加角色</a> </span>
                ...
                <table class="table table-border table-bordered table-hover table-bg">
                    ...
                    <tr class="text-c">
                        ...
                        <td class="f-14"><a title="编辑" href="javascript:;"
                                    ...
                                    title="删除" href="javascript:;" onclick="admin_role_del(this,'1')" class="ml-5"
...
<script type="text/javascript" src="<?=Yii::getAlias('@web')?>/lib/datatables/1.10.0/jquery.dataTables.min.js"></script>
